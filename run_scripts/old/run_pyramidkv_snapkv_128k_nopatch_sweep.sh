...
OUT_DIR=outputs/${MODEL_NAME}${TAG}/NOPATCH64_outputs${SUFFIX}__${METHOD}
...
sbatch<<EOT
#!/bin/bash -l
#SBATCH --job-name=NEW_NOPATCH64_helmet-${TASK_NAME}-${METHOD}-${SPARSITY}-${MODEL_NAME}
...
for TASK in ${tasks[@]} ; do 
    ...
    for METHOD in pyramidkv; do # snapkv
