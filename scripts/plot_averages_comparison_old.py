...
#                 'LongProc: Token Eviction Methods')
...
# fig_1x2, axes_1x2 = plt.subplots(1, 2, figsize=(16, 8))
...
# plot_combined_comparison(axes_1x2[1], kv_techniques, 'Token Eviction Methods')
...
plot_all_techniques_combined(ax, all_techniques_combined,
...
for tech in all_techniques_combined:
    if tech in marker_dict:
