...
# Technique: streamingllm_n4092_i4, Model: Yarn-Qwen3-8B, Task: icl_banking, Context: 16k
...
# SLURM Configuration
JOB_TIME="12:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_streamingllm_n4092_i4_Yarn_Qwen3_8B_icl_banking_eval"
