...
# Technique: pyramidkv_k7_w2048_c8192_avgpool, Model: DeepSeek-R1-Distill-Llama-8B, Task: cite, Context: 16k
...
# SLURM Configuration
JOB_TIME="12:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_pyramidkv_k7_w2048_c8192_avgpool_DeepSeek_R1_Distill_Llama_8B_cite_eval"
