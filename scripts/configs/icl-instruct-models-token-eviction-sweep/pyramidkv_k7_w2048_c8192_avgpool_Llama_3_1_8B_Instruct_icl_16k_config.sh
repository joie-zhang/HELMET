...
# Technique: pyramidkv_k7_w2048_c8192_avgpool, Model: Llama-3.1-8B-Instruct, Task: icl, Context: 16k
...
# SLURM Configuration
JOB_TIME="1:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_pyramidkv_k7_w2048_c8192_avgpool_Llama_3_1_8B_Instruct_icl_eval"
