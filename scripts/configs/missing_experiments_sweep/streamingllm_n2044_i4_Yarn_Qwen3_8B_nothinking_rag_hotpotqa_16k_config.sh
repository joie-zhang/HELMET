...
# Technique: streamingllm_n2044_i4, Model: Yarn-Qwen3-8B, Task: rag_hotpotqa, Context: 16k
...
# SLURM Configuration
JOB_TIME="06:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_streamingllm_n2044_i4_Yarn_Qwen3_8B_nothinking_rag_hotpotqa_eval"
