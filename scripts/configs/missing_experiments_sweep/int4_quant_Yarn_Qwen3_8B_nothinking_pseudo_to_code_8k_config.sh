...
# Technique: int4_quant, Model: Yarn-Qwen3-8B, Task: pseudo_to_code, Context: 8k
...
# SLURM Configuration
JOB_TIME="18:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_int4_quant_Yarn_Qwen3_8B_nothinking_pseudo_to_code_eval"
