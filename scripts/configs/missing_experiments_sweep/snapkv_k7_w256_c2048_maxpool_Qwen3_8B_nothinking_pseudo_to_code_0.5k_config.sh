...
# Technique: snapkv_k7_w256_c2048_maxpool, Model: Qwen3-8B, Task: pseudo_to_code, Context: 0.5k
...
# SLURM Configuration
JOB_TIME="06:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_snapkv_k7_w256_c2048_maxpool_Qwen3_8B_nothinking_pseudo_to_code_eval"
