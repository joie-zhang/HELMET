...
# Technique: snapkv_k7_w256_c2048_maxpool, Model: Qwen2.5-7B-Instruct, Task: icl, Context: 32k
...
# SLURM Configuration
JOB_TIME="18:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_snapkv_k7_w256_c2048_maxpool_Qwen2_5_7B_Instruct_icl_eval"
