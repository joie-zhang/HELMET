...
# Technique: snapkv_k7_w2048_c8192_maxpool, Model: Yarn-Qwen3-8B, Task: niah, Context: 32k
...
# SLURM Configuration
JOB_TIME="18:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_snapkv_k7_w2048_c8192_maxpool_Yarn_Qwen3_8B_nothinking_niah_eval"
