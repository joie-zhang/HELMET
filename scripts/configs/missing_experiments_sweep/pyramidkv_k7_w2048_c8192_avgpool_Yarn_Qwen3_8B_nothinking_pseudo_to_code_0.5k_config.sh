...
# Technique: pyramidkv_k7_w2048_c8192_avgpool, Model: Yarn-Qwen3-8B, Task: pseudo_to_code, Context: 0.5k
...
# SLURM Configuration
JOB_TIME="06:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_pyramidkv_k7_w2048_c8192_avgpool_Yarn_Qwen3_8B_nothinking_pseudo_to_code_eval"
