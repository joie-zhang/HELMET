...
# Technique: int8_quant, Model: Yarn-Qwen3-8B, Task: travel_planning, Context: 0.5k
...
# SLURM Configuration
JOB_TIME="06:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_int8_quant_Yarn_Qwen3_8B_nothinking_travel_planning_eval"
