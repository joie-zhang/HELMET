...
# Technique: baseline, Model: Yarn-Qwen3-8B, Task: summ_multilex, Context: 32k
...
# SLURM Configuration
JOB_TIME="18:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_baseline_Yarn_Qwen3_8B_nothinking_summ_multilex_eval"
