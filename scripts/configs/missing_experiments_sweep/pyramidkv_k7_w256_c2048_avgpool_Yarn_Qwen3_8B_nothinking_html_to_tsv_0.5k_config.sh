...
# Technique: pyramidkv_k7_w256_c2048_avgpool, Model: Yarn-Qwen3-8B, Task: html_to_tsv, Context: 0.5k
...
# SLURM Configuration
JOB_TIME="06:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_pyramidkv_k7_w256_c2048_avgpool_Yarn_Qwen3_8B_nothinking_html_to_tsv_eval"
