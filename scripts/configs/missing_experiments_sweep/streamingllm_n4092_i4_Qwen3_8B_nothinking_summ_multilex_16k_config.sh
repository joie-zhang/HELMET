...
# Technique: streamingllm_n4092_i4, Model: Qwen3-8B, Task: summ_multilex, Context: 16k
...
# SLURM Configuration
JOB_TIME="06:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_streamingllm_n4092_i4_Qwen3_8B_nothinking_summ_multilex_eval"
