...
# Technique: streamingllm_n4092_i4, Model: Qwen3-8B, Task: html_to_tsv, Context: 8k
...
# SLURM Configuration
JOB_TIME="18:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_streamingllm_n4092_i4_Qwen3_8B_thinking_html_to_tsv_eval"
