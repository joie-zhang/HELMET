...
# Technique: pyramidkv_k7_w256_c2048_avgpool, Model: Yarn-Qwen3-8B, Task: icl, Context: 32k
...
# SLURM Configuration
JOB_TIME="18:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_pyramidkv_k7_w256_c2048_avgpool_Yarn_Qwen3_8B_nothinking_icl_eval"
