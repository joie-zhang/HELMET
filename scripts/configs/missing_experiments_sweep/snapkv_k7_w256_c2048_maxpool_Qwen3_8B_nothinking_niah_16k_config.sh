...
# Technique: snapkv_k7_w256_c2048_maxpool, Model: Qwen3-8B, Task: niah, Context: 16k
...
# SLURM Configuration
JOB_TIME="06:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_snapkv_k7_w256_c2048_maxpool_Qwen3_8B_nothinking_niah_eval"
