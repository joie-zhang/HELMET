...
# Technique: pyramidkv_k7_w2048_c8192_avgpool, Model: Yarn-Qwen3-8B, Task: rag_hotpotqa, Context: 32k
...
# SLURM Configuration
JOB_TIME="18:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_pyramidkv_k7_w2048_c8192_avgpool_Yarn_Qwen3_8B_nothinking_rag_hotpotqa_eval"
