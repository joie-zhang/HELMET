...
# Technique: streamingllm_n2044_i4, Model: Yarn-Qwen3-8B, Task: travel_planning, Context: 2k
...
# SLURM Configuration
JOB_TIME="12:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_streamingllm_n2044_i4_Yarn_Qwen3_8B_thinking_travel_planning_eval"
