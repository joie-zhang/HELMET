...
# Technique: int8_quant, Model: Yarn-Qwen3-8B, Task: recall_jsonkv, Context: 32k
...
# SLURM Configuration
JOB_TIME="18:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_int8_quant_Yarn_Qwen3_8B_nothinking_recall_jsonkv_eval"
