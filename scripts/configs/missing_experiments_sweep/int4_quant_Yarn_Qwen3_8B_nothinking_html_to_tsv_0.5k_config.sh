...
# Technique: int4_quant, Model: Yarn-Qwen3-8B, Task: html_to_tsv, Context: 0.5k
...
# SLURM Configuration
JOB_TIME="06:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_int4_quant_Yarn_Qwen3_8B_nothinking_html_to_tsv_eval"
