...
# Technique: streamingllm_n2044_i4, Model: Qwen3-8B, Task: rerank, Context: 32k
...
# SLURM Configuration
JOB_TIME="18:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_streamingllm_n2044_i4_Qwen3_8B_nothinking_rerank_eval"
