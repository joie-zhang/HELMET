...
# Technique: snapkv_k7_w2048_c8192_maxpool, Model: Yarn-Qwen3-8B, Task: recall_jsonkv, Context: 16k
...
# SLURM Configuration
JOB_TIME="06:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_snapkv_k7_w2048_c8192_maxpool_Yarn_Qwen3_8B_nothinking_recall_jsonkv_eval"
