...
# Technique: snapkv_k7_w2048_c8192_maxpool, Model: DeepSeek-R1-Distill-Qwen-7B, Task: icl_banking, Context: 16k, Time: 12:00:00
...
# SLURM Configuration
JOB_TIME="12:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_snapkv_k7_w2048_c8192_maxpool_DeepSeek_R1_Distill_Qwen_7B_icl_banking_eval"
