...
# Technique: streamingllm, Model: Yarn-Qwen3-8B, Task: pseudo_to_code, Context: 2k
...
# SLURM Configuration
JOB_TIME="6:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_streamingllm_Yarn_Qwen3_8B_pseudo_to_code_eval"
