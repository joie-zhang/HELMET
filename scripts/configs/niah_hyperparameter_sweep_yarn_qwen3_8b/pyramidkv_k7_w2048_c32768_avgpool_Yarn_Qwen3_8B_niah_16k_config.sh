...
# Technique: pyramidkv, Model: Yarn-Qwen3-8B, Window: 2048, Cache: 32768
...
# SLURM Configuration
JOB_TIME="1:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_pyramidkv_k7_w2048_c32768_avgpool_Yarn_Qwen3_8B_niah_eval"
