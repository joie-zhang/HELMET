...
# Window Size: 1024, Max Capacity: 8192
...
WINDOW_SIZE=1024                # Window size for KV cache methods
MAX_CAPACITY_PROMPT=8192      # Maximum capacity for prompt in KV cache
KERNEL_SIZE=5                 # Kernel size for attention pooling
POOLING="avgpool"             # Pooling method for attention (maxpool or avgpool)

# SLURM Configuration
JOB_TIME="1:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_w1024_c8192_eval"
