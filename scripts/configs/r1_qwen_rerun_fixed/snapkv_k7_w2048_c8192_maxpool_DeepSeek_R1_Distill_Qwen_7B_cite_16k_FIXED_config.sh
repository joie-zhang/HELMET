...
# Technique: snapkv_k7_w2048_c8192_maxpool, Model: DeepSeek-R1-Distill-Qwen-7B, Task: cite, Context: 16k
...
# SLURM Configuration
JOB_TIME="3:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_snapkv_k7_w2048_c8192_maxpool_DeepSeek_R1_Distill_Qwen_7B_cite_FIXED_eval"
