...
# Technique: pyramidkv_k7_w2048_c8192_avgpool, Model: DeepSeek-R1-Distill-Qwen-7B, Task: rag_hotpotqa, Context: 16k
...
# SLURM Configuration
JOB_TIME="3:00:00"
JOB_NAME="${EXP_TYPE}_${BENCHMARK}_pyramidkv_k7_w2048_c8192_avgpool_DeepSeek_R1_Distill_Qwen_7B_rag_hotpotqa_FIXED_eval"
