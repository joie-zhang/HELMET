...
fig.legend(
    ...
    bbox_to_anchor=(0.5, 0.02),  # Moved up slightly
    bbox_transform=fig.transFigure,  # Use figure coordinates
    title='Legend',
    fontsize=10,  # Added font size
)

# Adjusted tight_layout to leave more space at the bottom
plt.tight_layout(rect=[0, 0.08, 1, 0.98])  # Modified rect parameters
