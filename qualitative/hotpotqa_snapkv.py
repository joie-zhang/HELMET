...
def compare_predictions():
    # Load predictions for HotpotQA task
    snapkv_preds = load_predictions("/scratch/gpfs/DANQIC/jz4391/HELMET/output/snapkv/32k/Llama-3.1-8B-Instruct/w32_c1024_k7_maxpool/kilt_hotpotqa_16bit_snapkv_32k_Llama-3.1-8B-Instruct_w32_c1024_k7_maxpool_64411463_hotpotqa-dev-multikilt_1000_k220_dep3_in32768_size100_shots2_sampFalsemax128min0t0.0p1.0_chatFalse_42.json")
    baseline_preds = load_predictions("/scratch/gpfs/DANQIC/jz4391/HELMET/output/baseline/32k/Llama-3.1-8B-Instruct/16bit/kilt_hotpotqa_16bit_baseline_32k_Llama-3.1-8B-Instruct_16bit_64060299_hotpotqa-dev-multikilt_1000_k220_dep3_in32768_size100_shots2_sampFalsemax128min0t0.0p1.0_chatFalse_42.json")
    ...
    # Save full details
    with open('hotpotqa_snapkv_bidirectional_analysis.json', 'w') as f:
